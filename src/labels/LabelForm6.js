...
class LabelForm6 extends React.Component {
    ...
    jsPdfGenerator = (data) => {
        var options = {
           ...
           // adiing some text
           doc.addImage(labels[6], 'JPEG', 0, 0, 297, 210)
           ...
           doc.text(71, 69, data.get("substance"), {maxWidth:110})
    ...
    render(){
        ...
        <Container>
            <Form.Label>{labelText[this.state.language]['Waste containing Mercury or its derivatives']}</Form.Label>
            <Row>
                <Col>
                    <Form.Check
                        custom
