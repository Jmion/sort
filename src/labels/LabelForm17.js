...
class LabelForm17 extends React.Component {
  constructor(props) {
    super(props);
  ...
  jsPdfGenerator = data => {
    ...
    // adiing some text
    doc.addImage(labels[17], "JPEG", 0, 0, 297, 210);

    //OMoD
    doc.setFont("arial");
    doc.setFontType("bold");
    doc.setFontSize(16);
    doc.text(120, 40.5, data.get("omod"));
    ...
    doc.setFontSize(10);
    doc.setFontType("normal");
    doc.text(44, 71.7, data.get("materials"), { maxWidth: 100 });
    doc.text(47, 88, data.get("substance"), { maxWidth: 90 });
    doc.text(41, 96, data.get("metal"), { maxWidth: 90 });
      ...
      <div className="LabelFormLayout container">
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Group controlId="substance">
            ...
            <Form.Control as="textarea" rows="3" name="substance" />
          </Form.Group>
          ...
          <Form.Group controlId="materials">
            ...
            <Form.Control as="textarea" rows="3" name="materials" />
          </Form.Group>
          ...
          <Container>
            <Col>
              <Form.Check
                ...
                name="nanoparticules"
                label={labelText[this.state.language]["with nanoparticles"]}
                type="checkbox"
                id={"nanoparticules"}
              />
            </Col>
