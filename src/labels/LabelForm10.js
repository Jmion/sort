...
class LabelForm10 extends React.Component {
    ...
    jsPdfGenerator = (data) => {
        var options = {
           ...
           // adiing some text
           doc.addImage(labels[10], 'JPEG', 0, 0, 297, 210)
           ...
           doc.text(50, 69, data.get("substance"), {maxWidth:110})
           doc.text(42, 81.3, data.get("solvent"), {maxWidth:110})
