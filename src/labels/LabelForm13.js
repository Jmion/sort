...
class LabelForm13 extends React.Component {
  constructor(props) {
    super(props);
  ...
  jsPdfGenerator = data => {
    ...
    // adiing some text
    doc.addImage(labels[13], "JPEG", 0, 0, 297, 210);
    ...
    doc.text(50, 68.3, data.get("substance"), { maxWidth: 110 });
    ...
    return (
      <div>
        <Form className="LabelFormLayout" onSubmit={this.handleSubmit}>
          ...
          <DangerPictogramCheckbox language={this.state.language} labelNumber={this.state.formNumber} />
