...
class LabelForm12 extends React.Component {
    ...
    jsPdfGenerator = (data) => {
        var options = {
           ...
           // adiing some text
           doc.addImage(labels[12], 'JPEG', 0, 0, 297, 210)
           ...
           // Remettant
           doc.text(90, 10.3, data.get("remettant"))

           // Group
           doc.text(6, 50, data.get("group name"),{maxWidth: 15})

           // Name
           doc.text(6, 72, data.get("first name") + " " + data.get("last name"), {maxWidth: 15})
           ...
           doc.text(50, 68.4, data.get("substance"), {maxWidth:110})
           doc.text(42, 80.8, data.get("solvent"), {maxWidth:110})
